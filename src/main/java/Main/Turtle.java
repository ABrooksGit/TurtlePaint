 ...
 * Usage example:
 * <pre>
 * Main.World w = new Main.World();
 *
 * Main.Turtle t = new Main.Turtle(w);
 * t.forward(300);
 * t.setPenWidth(10);
 * t.backward(100);
 * t.right(135);
...
public class Turtle {
     ...
     * Should only be called by Main.World class
    ...
    /**
     * Returns the current Color of the Main.Turtle.
    ...
    /**
     * Changes the current Color of the Main.Turtle.
    ...
    /**
     * Find out what direction the Main.Turtle is facing
    ...
    /**
     * Set the direction the Main.Turtle is facing
