 ...
 * Usage example:
 * <pre>
 * Main.World basic = new Main.World();
 * Main.World fancy = new Main.World(640, 480, Color.YELLOW);
 *
 * Main.Turtle t1 = new Main.Turtle(basic);
 * Main.Turtle t2 = new Main.Turtle(fancy);
 *
 * t1.forward(100);
 * basic.erase();
 * t1.turnLeft(90);
...
public class World extends JFrame {
    ...
    /**
     * Creates a new Main.World for Turtles to play in.
     */
    public World() {
        this(600, 600);
    }
    ...
    /**
     * Should only called by the Main.Turtle class constructor
     */
    ...
    /**
     * Should only called by Main.Turtle class methods
     */
    ...
    /**
     * To be used by Main.Turtle class only
